...
class get_tiketclose extends CI_Model {
    ...
    function get_data(){
        ...
        $clouse = " where b.kejadian_status = 'close'";
        ...
        $resuld = $process_table->coba_db($sql, $page, $iDisplayLength, true, "../../../index.php/tiketclose/edit", "../../../index.php/tiketclose/hapus");

...
class tiketopen extends CI_Controller {
    
    public $layout;
    
    public function __construct() {
        parent::__construct();
        $this->load->model('get_tiketopen');
        $this->layout = new layout('lite');
        Privilege::admin();
    }

    public function get_tiketopen() {
        $this->get_tiketopen->get_data();
    }

    public function script_table(){
        return $this->layout->loadjs("tiketopen/get_tiketopen");
    }
    
    public function hapus($id){
        $_GET['id'] = $id;
        
        $this->get_tiketopen->process(array(
            'action' => 'delete',
            'table' => 'hdcasedaftar',
            'where' => 'notiket = \''.$id.'\''
        ));
    ...
    public function edit($id){
        ...
        $this->layout->loadView('tiketopen_form', array(

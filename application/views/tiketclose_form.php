        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6">
                    <button style="width: 100%; background: -webkit-gradient(linear, left bottom, left top, color-stop(0, #f1f1f1), color-stop(1, #ffffff)) !important;" type="button" class="btn btn-default bg-aqua-gradient" onclick="move_url('tiketclose');">Lihat Data</button>
                </div>
            </div>
        </div>
    </form>
